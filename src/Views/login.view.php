        ...
        <div class="container">
            <div class="form-group">
                ...
                if(isset($this->errors['email'])){
                    ?>
                        <!-- Dans un éccho php, on affiche l'erreur qu'il y a dans l'email en rouge -->
            ...
            <div class="form-group">
                <label for="password" class="form-label">Donne moi ton mot de passe :</label>
                <input type="password" name="password" id="password" class="form-control">
                <?php
                // S'il existe une erreur sur le mot de passe dans le tableau d'erreur
                if(isset($this->errors['password'])){
                    ?>
                        <!-- Dans un éccho php, on affiche l'erreur qu'il y a dans le password en rouge -->
                        <p class="text-danger"><?= $this->errors['password'] ?></p>
                    <?php
                }
                ?>
            </div>
            <!-- Création d'un bouton jaune de type sumbit pour envoyer les données du formulaire au serveur (name permet de récupérer la méthode login dans dans SessionConntroller -->
            <button type="submit" name="login" class="btn btn-warning my-4">Connexion</button>
        </div>
    </form>
</main>
