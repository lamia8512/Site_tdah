    ...
    <div class="container">
        <div class="form-group">
            ...
            if(isset($this->errors['email'])){
                ?>
                    <!--Dans une balise paragraphe, on fait un éccho php, pour afficher l'erreur qu'il y a dans l'email-->
        ...
        <div class="form-group">
            ...
            if(isset($this->errors['password'])){
                ?>
                    <!--Dans une balise paragraphe, on fait un éccho php, pour afficher l'erreur dans le password-->
