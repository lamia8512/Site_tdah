    ...
    <form method="POST">
        <div class="container">
            <div class="form-group">
                ...
                <?php 
                // S'il existe une erreur sur le pseudo alors on affiche le message qui se trouve dans la clé erreur "pseudo" en rouge
            ...
            <div class="form-group">
                ...
                <?php 
                // S'il existe une erreur sur le mail alors on affiche le message qui se trouve dans la clé erreur "email" en rouge
            ...
            <div class="form-group">
                ...
                <?php
                // S'il existe une erreur sur le mot de passe alors on affiche le message qui se trouve dans la clé erreur "password" en rouge
            ...
            <!-- Création d'un bouton bleu de type sumbit pour envoyer les données du formulaire au serveur (name permet de récupérer la méthode register dans RegisterConntroller -->
            <button type="submit" name="register" class="btn btn-primary my-4">Inscription</button>
        </div>
    </form>
</main>
